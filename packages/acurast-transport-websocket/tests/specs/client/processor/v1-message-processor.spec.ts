...
} from '../../../../src/client/processor/message-processor'
...
describe('V1MessageProcessor', function () {
  it('processes InitMessage', async function () {
    ...
    const keyPair: KeyPair = {
      secretKey: Buffer.from(
        '6395bd8e07cbdd6af107d90cd5cb20930af9c9e7587ed605383072795c1590ec',
        'hex',
      ),
      publicKey: Buffer.from(
        '028400fdb370c84c566d1f05bf7ed41dc72e618561cb8815d46dbccad7ea7bd077',
        'hex',
      ),
    }
    ...
    const actionOrUndefined: ProcessorAction | undefined = await processor.processMessage(
      initMessage,
      keyPair,
    )
  ...
  it('processes ChallengeMessage', async function () {
    ...
    expect(Buffer.from(message.signature).toString('hex')).to.eq(
      '64648baaca7bb7d5603f8a42132c648a78b91b34c5209ccebe43e0a39b96d99cbff07a380f2e857f73dab74d018ef088d0a885899e25cf24af7b619658879d94',
    )
  })
