...
describe('V1Forger', function () {
  it('forges InitMessage', function () {
    ...
    expect(forged.toString('hex')).to.eq(
      '108c30e6864d09f7a3a05b84d44c7d846000000000000000000000000000000000',
    )
  })
  ...
  it('forges ChallengeMessage', function () {
    ...
    expect(forged.toString('hex')).to.eq(
      '11000000000000000000000000000000008c30e6864d09f7a3a05b84d44c7d8460ffffffffffffffffffffffffffffffff802e4f57093eed0b54a4569c0f10748d',
    )
  })
  ...
  it('forges ResponseMessage', function () {
    ...
    const publicKey: Buffer = Buffer.from(
      '0338f595e8b20754d4b4520d47bbf152ce574d7bf0cbfb4d984aa6b5025c1483b1',
      'hex',
    )
    const nonce: Buffer = Buffer.from('00000000000000000000000000000000', 'hex')
    const signature: Buffer = Buffer.from(
      '1a53e66510f16aa6905a525f332670f10df1f044f7910faeda1f038fd7a53c59503060c492bcf4ae0fe6398e1364db93a1691f4441201284f438b302fa47c109',
      'hex',
    )
    ...
    expect(forged.toString('hex')).to.eq(
      '',
    )
  })
  ...
  it('forges AcceptedMessage', function () {
    ...
    expect(forged.toString('hex')).to.eq(
      '13000000000000000000000000000000008c30e6864d09f7a3a05b84d44c7d8460',
    )
  })
  ...
  it('forges PayloadMessage', function () {
    ...
    expect(forged.toString('hex')).to.eq(
      '148c30e6864d09f7a3a05b84d44c7d8460dc6e99132174e7f640ea5b7364c00b786d657373616765',
    )
  })
})
